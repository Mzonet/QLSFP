...
map.getView().fit([1958446.640791, -4157427.955897, 2674763.332230, -3587054.427410], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">QLFSP Interactive Map Search Application</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (121 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Interactive Map - Showing PSUs for Rotation 1 - 4 ( 234)<br />PSU No<br />Ward No<br />Adress No where therers is Landparcel / Cadastral';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_QLFSP_Rot1_4LatLong_2,
    colName: 'PSU_NO_M',
    zoom: 10,
    collapsed: true,
    map: map,
